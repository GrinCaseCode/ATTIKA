...
/*input file*/
	...
	$(".dropdown-catalog__title").click(function() {
		$(this).toggleClass("active");
	...
	$(".main-language__value").click(function() {
		if ($(".main-language__dropdown").is(":hidden")) {
			$(".main-language__dropdown").slideDown(200);
		} else {
			$(".main-language__dropdown").slideUp(200);
		}
	});
	...
	$('.tabs li a').click(function(event) {
		...
		$(this).parent().parent().parent().find('.slider-catalog').slick('setPosition');
		$(this).parent().parent().parent().find('.slider-team').slick('setPosition');
	});
